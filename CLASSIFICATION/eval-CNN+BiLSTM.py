...
def creat_split_loader(batch_size = 64,file_path = '',select_data = [], test_size = 0.2):
...
def main():
    ...
    parser.add_argument('--train_file_path', default='/home/chenkp/CODA/gastric/classification/data/fanhua/PRAD-TCGA_log2EXP-train.csv')
    parser.add_argument('--test_file_path', default='/home/chenkp/CODA/gastric/classification/data/STAD_test_exp_combat1.csv')
    parser.add_argument('--predict_label_txt', default='/home/chenkp/CODA/gastric/classification/result/eval-CNN+BiLSTM/label_predict.txt')
    parser.add_argument('--best_model_path', default='/home/chenkp/CODA/gastric/classification/result/CNN+BiLSTM/best_model_3.pth')
    ...
    parser.add_argument('--trail', default=2, type=int)
    ...
    path = "/home/chenkp/CODA/gastric/classification/result/eval-CNN+BiLSTM/"
    draw_auc(score_list, label_list, path, dataset)
